...
class Vec2 {
  ...
  public Vec2 set(Vec2 value) {
    this.x = this.s = this.u = value.x ;
    this.y = this.t = this.v = value.y ;
    return this;
  }
...
class Vec3 {
   ...
   */
   ...
   public Vec3 set(float value) {
    this.x = this.r = this.s = this.y = this.g = this.t = this.z = this.b = this.p = value ;
    return this;
  }
  ...
  public Vec3 set(Vec3 value) {
    this.x = this.r = this.s = value.x ;
    this.y = this.g = this.t = value.y ;
    this.z = this.b = this.p = value.z ;
    return this;
  }
...
class Vec4 {
   ...
   */
    ...
    this.x = this.r = this.s = this.y = this.g = this.t = this.z = this.b = this.p = this.w = this.a = this.q = value ;
    return this;
  }
